    ...
    return (
        <div className={s.app} {...handlers}>
            ...
            <div className={s.buttons}>
                <button  onClick={() => publisherStore.dispatch("rotateFigure")(Axis.X, 90)}>
                ...
                <button onClick={() => publisherStore.dispatch("rotateFigure")(Axis.Y, 90)}>
                ...
                <button onClick={() => publisherStore.dispatch("rotateFigure")(Axis.Z, 90)}>
